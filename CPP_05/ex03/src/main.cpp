...
//declare bureaucrats and forms
	...
	AForm*	notAForm = intern.makeForm("nonsense", "no one");
	AForm*	plantSomeTree = intern.makeForm("ShrubberyCreationForm", "acacia");
	AForm*	robotomy = intern.makeForm("robotomy request", "Bender");
	AForm*	pardon = intern.makeForm("Could you please bring me a coffe? ah! also make a pardon form please, thanks", "Philip J. fry");
